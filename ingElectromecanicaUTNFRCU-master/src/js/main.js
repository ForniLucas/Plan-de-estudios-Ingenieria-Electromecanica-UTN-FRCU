let materiasISI = JSON.parse(localStorage.getItem('materiasISI')) || [
  // Primer año
  // - Anual
  { id: '2', nombre: 'Ingenielectromecanfsdfsdfica',         horas: '3',  ano: '1', cuatrimestre: '0', esAnual: true,  estado: 'desaprobada', analista: false, integradora: true,  electiva: false, paraCursar: { necesitaRegular: [], necesitaAprobada: [] } },
  // - Primer cuatrimestre
  { id: '3', nombre: 'Álgebra y Geometradsadsía Analítica',     horas: '10', ano: '1', cuatrimestre: '1', esAnual: false, estado: 'desaprobada', analista: false, integradora: false, electiva: false, paraCursar: { necesitaRegular: [], necesitaAprobada: [] } },
  ...
  // Tercer año
  // - Anual
  { id: '16', nombre: 'Inglés II',                       horas: '2', ano: '3', cuatrimestre: '0', esAnual: true,  estado: 'desaprobada', analista: false, integradora: false, electiva: false, paraCursar: { necesitaRegular: [],                 necesitaAprobada: ['13']} },
  ...
  { id: '32', nombre: 'Teoría de Control',          horas: '6', ano: '4', cuatrimestre: '2', esAnual: false, estado: 'desaprobada', analista: false, integradora: false, electiva: false, paraCursar: { necesitaRegular: ['5', '21'],        necesitaAprobada: ['9', '18']} },
